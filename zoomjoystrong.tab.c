...
static const char *const yytname[] =
{
  ...
  "CIRCLE", "RECTANGLE", "SET_COLOR", "INT", "FLOAT", "STRING", "$accept",
  "drawing_list", "drawing", "point", "line", "circle", "rectangle",
